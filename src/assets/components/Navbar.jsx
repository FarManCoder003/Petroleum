      ...
      <nav className="bg-[#F40404] py-3 px-1">
        <div className="max-w-container mx-auto">
          <div className="flex justify-between items-center">
            ...
            <div className="">
              <ul
                className={`lg:flex gap-x-[47px] items-center absolute top-0 left-[-500px] lg:static duration-700 ease-in-out ${ show == true ? "bg-[#F40404] w-fill px-5 py-2 top-[165px] left-[60%] text-center" : "bg-[#F40404] w-fill px-5 py-2 top-[165px] text-center" }`}
              >
                <li>
